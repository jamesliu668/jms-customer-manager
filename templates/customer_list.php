		...
		<tr id="post-20" class="iedit author-self level-0 post-20 type-post status-publish format-standard hentry category-uncategorized">
            ...
            <td class="title column-title has-row-actions column-primary page-title">
                ...
                <div class="row-actions">
                    ...
                    <span class="trash"><a href="<?php echo $wp->request; ?>admin.php?page=jms-customer-manager-top&id=<?php echo $data["id"];?>&action=delete&_wpnonce=<?php echo wp_create_nonce( 'delete-customer-'.$data["id"] );?>" class="submitdelete">移至回收站</a> | </span>
                </div>
            </td>
