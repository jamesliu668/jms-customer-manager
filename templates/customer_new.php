...
<table class="form-table">
    <tbody>
        <tr>
            ...
            <td>
                <input name="customer_name" type="text" id="customer_name" value="" class="regular-text">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input name="wechat_id" type="text" id="wechat_id" value="" class="regular-text">
        ...
        <tr>
            ...
            <td>
                <input name="customer_tier" type="text" id="customer_tier" value="" class="regular-text">
        ...
        <tr>
            ...
            <td>
                <textarea name="customer_child" id="customer_child" rows="5" cols="53"></textarea>
        ...
        <tr>
            ...
            <td>
                <textarea name="customer_interest" id="customer_interest" rows="5" cols="53"></textarea>
        ...
        <tr>
            ...
            <td>
                <textarea name="customer_desc" id="customer_desc" rows="5" cols="53"></textarea>
